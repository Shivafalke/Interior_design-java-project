    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <h1 class="text-center mb-4">Upload Image : Bedroom</h1>
                <form action="AddImageVendorBedroom" method="post" enctype="multipart/form-data">
        ...
        <div class="container">
            <div class="row pt-3">
                ...
                int Vendorid = (Integer)session.getAttribute("vendorid");
                                ...
                                List<MyImage> images = new ImageDAOvendor().getAllImagesDataVendorBedroom(Vendorid);
