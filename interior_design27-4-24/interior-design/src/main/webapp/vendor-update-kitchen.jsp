...
<html>
<head>
    <title>Image Gallery Vendor</title>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <h1 class="text-center mb-4">Upload Image : Kitchen</h1>
                <form action="AddImageVendorKitchen" method="post" enctype="multipart/form-data">
    ...
    <section style="padding-top: 70px; padding-bottom: 70px;"> 
        <div class="container">
            <div class="row pt-3">
                ...
                List<MyImage> images = new ImageDAOvendor().getAllImagesDatakitchenVendors(Vendorid);
