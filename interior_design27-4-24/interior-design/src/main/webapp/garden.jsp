...
<body>
          ...
          <div id="custCarousel" class="carousel slide" data-ride="carousel" align="center">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/home79.jpg" alt="Hills" style="height: 500px; width: 900px;">
              </div>
    
              <div class="carousel-item">
                <img src="images/home80.jpg" alt="Hills" style="height: 500px; width: 900px;">
              </div>
    
              <div class="carousel-item">
                <img src="images/home81.jpeg" alt="Hills" style="height: 500px; width: 900px;">
              </div>
    
              <div class="carousel-item">
                <img src="images/home82.jpg" alt="Hills" style="height: 500px; width: 900px;">
              </div>
            </div>
            ...
            <ol class="carousel-indicators list-inline">
              <li class="list-inline-item active">
                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#custCarousel">
                  <img src="images/home79.jpg" class="img-fluid">
                </a>
              </li>
    
              <li class="list-inline-item">
                <a id="carousel-selector-1" data-slide-to="1" data-target="#custCarousel">
                  <img src="images/home80.jpg" class="img-fluid">
                </a>
              </li>
    
              <li class="list-inline-item">
                <a id="carousel-selector-2" data-slide-to="2" data-target="#custCarousel">
                  <img src="images/home81.jpeg"  class="img-fluid">
                </a>
              </li>
    
               <li class="list-inline-item">
                <a id="carousel-selector-2" data-slide-to="3" data-target="#custCarousel">
                  <img src="images/home82.jpg"  class="img-fluid">
                </a>
              </li>
             </ol>
          </div>
 ...
 <section style="padding-top: 100px; padding-bottom: 100px;">
  <h1 class="text-center">Impressive Collection For Your Dream Garden</h1>
  <div class="container">
    <div class="row pt-3">
      <% 
        // Get the list of all images from the database using ImageDAO class
        List<MyImage> images = new ImageDAO().getAllImagesDatagarden();
      ...
      <% } %>
            <% 
        // Get the list of all images from the database using ImageDAO class
        List<MyImage> imagess = new ImageDAOvendor().getAllImagesDataVendorGarden();
