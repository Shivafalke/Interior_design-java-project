...
<body>
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">pshomedecore@gmail.com</span>
					    </div>
          ...
          <div id="custCarousel" class="carousel slide" data-ride="carousel" align="center">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/home69.jpg" alt="Hills" style="height: 500px; width: 900px;">
              </div>
    
              <div class="carousel-item">
                <img src="images/home70.jpg" alt="Hills" style="height: 500px; width: 900px;">
              </div>
    
              <div class="carousel-item">
                <img src="images/home71.jpg" alt="Hills" style="height: 500px; width: 900px;">
              </div>
    
              <div class="carousel-item">
                <img src="images/home72.jpg" alt="Hills" style="height: 500px; width: 900px;">
              </div>
            </div>
            ...
            <ol class="carousel-indicators list-inline">
              <li class="list-inline-item active">
                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#custCarousel">
                  <img src="images/home69.jpg" class="img-fluid">
                </a>
              </li>
    
              <li class="list-inline-item">
                <a id="carousel-selector-1" data-slide-to="1" data-target="#custCarousel">
                  <img src="images/home70.jpg" class="img-fluid">
                </a>
              </li>
    
              <li class="list-inline-item">
                <a id="carousel-selector-2" data-slide-to="2" data-target="#custCarousel">
                  <img src="images/home71.jpg"  class="img-fluid">
                </a>
              </li>
    
               <li class="list-inline-item">
                <a id="carousel-selector-2" data-slide-to="3" data-target="#custCarousel">
                  <img src="images/home72.jpg"  class="img-fluid">
                </a>
              </li>
             </ol>
          </div>
  ...
  <h1 class="text-center">Impressive Collection For Your Dream Bedroom</h1>
  <div class="container">
    <div class="row pt-3">
      <% 
        // Get the list of all images from the database using ImageDAO class
        List<MyImage> images = new ImageDAO().getAllImagesDatabedroom();
      ...
      <% } %>
            <% 
        // Get the list of all images from the database using ImageDAO class
        List<MyImage> imagess = new ImageDAOvendor().getAllImagesDataVendorBedroom();
    ...
    <section style="padding-bottom: 80px;">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="images/home73.jpg" alt="Card image cap" style="height: 250px; width: 285px;">
                        <div class="card-body">
                          <p class="card-text text-center"><b>Master Bedroom</b></p>
                        </div>
                      </div>
                </div>
                <div class="col-sm-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="images/home74.jpg" alt="Card image cap" style="height: 250px; width: 285px;">
                        <div class="card-body">
                          <p class="card-text text-center"><b>Guest Bedroom</b></p>
                        </div>
                      </div>
                </div>
                <div class="col-sm-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="images/home75.jpg" alt="Card image cap" style="height: 250px; width: 285px;">
                        <div class="card-body">
                          <p class="card-text text-center"><b>Teen_ Bedroom</b></p>
                        </div>
                      </div>
                </div>
            </div>
            <div class="row pt-5">
                <div class="col-sm-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="images/home76.jpg" alt="Card image cap" style="height: 250px; width: 285px;">
                        <div class="card-body">
                          <p class="card-text text-center"><b>Master Bedroom</b></p>
                        </div>
                      </div>
                ...
                <div class="col-sm-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="images/home77.jpg" alt="Card image cap" style="height: 250px; width: 285px;">
                        <div class="card-body">
                          <p class="card-text text-center"><b>Guest Bedroom</b></p>
                        </div>
                      </div>
                ...
                <div class="col-sm-4">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="images/home78.jpg" alt="Card image cap" style="height: 250px; width: 285px;">
                        <div class="card-body">
                          <p class="card-text text-center"><b>Teen_ Bedroom</b></p>
                        </div>
                      </div>
    ...
    <section style="padding-bottom: 100px; background-color: rgb(229, 225, 225);">
        <div class="container">
